...
| 14 | **Explorador visual del cubo** | Diagrama interactivo de la constelación, catálogo de medidas y laboratorio OLAP alimentado por el JSON de la landing. |
...
landing/                              Portal de abastecimiento (ver su README)
  ...
  cubo.html   cubo.css   cubo.js       Explorador visual y laboratorio OLAP
